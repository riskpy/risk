...
begin
  ...
  l_varchar2(1) :=q'!1012!';
  l_clob(2) :=q'!P!';
  l_clob(3) :=q'!PARAMETROS_VALIDACION_CREDENCIALES_RISK!';
  l_clob(4) :=q'!!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Parámetros necesarios para validación de credenciales con el método RISK!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!0!';
  l_clob(9) :=q'!!';
  l_clob(10) :=q'!K!';
