...
begin
  ...
  l_varchar2(1) :=q'!36!';
  l_clob(2) :=q'!R!';
  l_clob(3) :=q'!LISTAR_SIGNIFICADOS!';
  l_clob(4) :=q'!GEN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!!';
  l_clob(7) :=q'!0.1.0!';
...
begin
  ...
  l_varchar2(1) :=q'!36!';
  l_clob(2) :=q'!C!';
  l_clob(3) :=q'!SELECT dominio, codigo, significado, referencia, activo FROM t_significados ORDER BY dominio, codigo!';

  insert into t_reportes_dml_v
  (
     "ID_REPORTE"
    ,"TIPO"
    ,"CONSULTA_SQL"
...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!REPORTE:GEN:LISTAR_SIGNIFICADOS!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
