...
begin
  ...
  l_varchar2(1) :=q'!11!';
  l_clob(2) :=q'!ACCESS_TOKEN_ANTIGUO!';
  l_clob(3) :=q'!0.1.0!';
  l_varchar2(4) :=q'!1!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!S!';
  ...
  l_varchar2(1) :=q'!11!';
  l_clob(2) :=q'!REFRESH_TOKEN_ANTIGUO!';
  l_clob(3) :=q'!0.1.0!';
  l_varchar2(4) :=q'!2!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!S!';
  ...
  l_varchar2(1) :=q'!11!';
  l_clob(2) :=q'!REFRESH_TOKEN_NUEVO!';
  l_clob(3) :=q'!0.1.0!';
  l_varchar2(4) :=q'!4!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!S!';
...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!SERVICIO:AUT:REFRESCAR_SESION!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
