...
begin
  ...
  l_varchar2(1) :=q'!2000!';
  l_clob(2) :=q'!T!';
  l_clob(3) :=q'!MONITOREO_CONFLICTOS_MENSUAL!';
  l_clob(4) :=q'!GEN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Trabajo de monitoreo de conflictos - Frecuencia Mensual!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!2!';
  l_clob(9) :=q'!!';
  l_clob(10) :=q'!K!';
...
begin
  ...
  l_varchar2(4) :=q'!!';
  l_varchar2(5) :=q'!!';
  l_clob(6) :=q'!FREQ=MONTHLY;BYMONTHDAY=1;BYHOUR=12;BYMINUTE=10;BYSECOND=0;!';
  l_varchar2(7) :=q'!!';
  l_clob(8) :=q'!Trabajo de monitoreo de conflictos - Mensual!';
