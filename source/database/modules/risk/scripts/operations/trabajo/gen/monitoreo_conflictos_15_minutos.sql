...
begin
  ...
  l_varchar2(1) :=q'!2008!';
  l_clob(2) :=q'!T!';
  l_clob(3) :=q'!MONITOREO_CONFLICTOS_15_MINUTOS!';
  l_clob(4) :=q'!GEN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Trabajo de monitoreo de conflictos - Frecuencia Cada 15 Minutos!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!0!';
  l_clob(9) :=q'!!';
  l_clob(10) :=q'!K!';
...
begin
  ...
  l_varchar2(4) :=q'!!';
  l_varchar2(5) :=q'!!';
  l_clob(6) :=q'!FREQ=MINUTELY;BYMINUTE=25,55;BYSECOND=0;!';
  l_varchar2(7) :=q'!!';
  l_clob(8) :=q'!Trabajo de monitoreo de conflictos - Cada 15 Minutos!';
