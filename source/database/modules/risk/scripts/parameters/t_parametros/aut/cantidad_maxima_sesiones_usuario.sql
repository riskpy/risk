...
begin
  ...
  l_clob(2) :=q'!CANTIDAD_MAXIMA_SESIONES_USUARIO!';
  l_clob(3) :=q'!Cantidad máxima permitida de sesiones activas por usuario!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!CANTIDAD_MAXIMA_SESIONES_USUARIO!';
  l_clob(2) :=q'!2!';
