...
begin
  ...
  l_clob(2) :=q'!CONFIRMACION_DIRECCION_CORREO!';
  l_clob(3) :=q'!Indica si está activa la confirmación de correo electrónico de usuarios (S/N)!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!CONFIRMACION_DIRECCION_CORREO!';
  l_clob(2) :=q'!S!';
