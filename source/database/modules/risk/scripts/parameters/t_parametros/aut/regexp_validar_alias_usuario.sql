...
begin
  ...
  l_clob(2) :=q'!REGEXP_VALIDAR_ALIAS_USUARIO!';
  l_clob(3) :=q'!Expresión Regular para validación de alias de usuario!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!REGEXP_VALIDAR_ALIAS_USUARIO!';
  l_clob(2) :=q'!^[A-Za-z0-9_]{1,50}$!';
