...
begin
  ...
  l_clob(2) :=q'!ESTADOS_ACTIVOS_USUARIO!';
  l_clob(3) :=q'!Estados de usuario válidos para inicio de sesión. Separadas por coma. Ej.: A,P!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!ESTADOS_ACTIVOS_USUARIO!';
  l_clob(2) :=q'!A!';
