...
begin
  ...
  l_clob(2) :=q'!CHARSET_EXPORTACION_SCRIPTS!';
  l_clob(3) :=q'!Juego de caracteres para exportación de scripts!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!CHARSET_EXPORTACION_SCRIPTS!';
  l_clob(2) :=q'!WE8MSWIN1252!';
