...
begin
  ...
  l_clob(2) :=q'!URL_SERVICIOS_PRODUCCION!';
  l_clob(3) :=q'!URL base de los Servicios Web del entorno de Producción!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!URL_SERVICIOS_PRODUCCION!';
  l_clob(2) :=q'!https://localhost:5001!';
