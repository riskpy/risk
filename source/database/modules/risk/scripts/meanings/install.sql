prompt
prompt Instalando significados...
prompt -----------------------------------
prompt
@@scripts/meanings/api/frecuencia_monitoreo.sql
@@scripts/meanings/api/tipo_dato_parametro.sql
@@scripts/meanings/api/tipo_implementacion.sql
@@scripts/meanings/api/tipo_operacion.sql
@@scripts/meanings/api/tipo_reporte.sql
@@scripts/meanings/api/tipo_servicio.sql
...
@@scripts/meanings/gen/extension_reporte.sql
@@scripts/meanings/gen/origen_usuario.sql
@@scripts/meanings/gen/tipo_aplicacion.sql
@@scripts/meanings/gen/tipo_dispositivo.sql
@@scripts/meanings/gen/tipo_persona.sql
