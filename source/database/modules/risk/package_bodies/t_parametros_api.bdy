CREATE OR REPLACE PACKAGE BODY T_PARAMETROS_API IS
  /*
  ...
  */
  ...
  BEGIN
    FORALL i IN INDICES OF p_rows_tab
      ...
      SET
        ...
        FECHA_MODIFICACION   = systimestamp
      WHERE
        ID_PARAMETRO = p_rows_tab(i).ID_PARAMETRO;
  END update_rows;
  ...
  BEGIN
    FORALL i IN INDICES OF p_rows_tab
      DELETE FROM T_PARAMETROS
       WHERE ID_PARAMETRO = p_rows_tab(i).ID_PARAMETRO;
  END delete_rows;
