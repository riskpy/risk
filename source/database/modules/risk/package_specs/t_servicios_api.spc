CREATE OR REPLACE PACKAGE T_SERVICIOS_API IS
  /*
  ...
  <options
    ...
    p_dml_view_name="T_SERVICIOS_DML_V"
    p_dml_view_trigger_name="T_SERVICIOS_IOIUD"
    p_enable_one_to_one_view="TRUE"
    p_one_to_one_view_name="T_SERVICIOS_V"
    p_api_name="T_SERVICIOS_API"
    p_sequence_name=""
  ...
  */
  ...
  TYPE t_rows_tab          IS TABLE OF T_SERVICIOS%ROWTYPE;
  TYPE t_strong_ref_cursor IS REF CURSOR RETURN T_SERVICIOS%ROWTYPE;
