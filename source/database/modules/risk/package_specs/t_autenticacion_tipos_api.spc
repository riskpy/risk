CREATE OR REPLACE PACKAGE T_AUTENTICACION_TIPOS_API IS
  /*
  ...
  <options
    ...
    generated_by="JAVIER"
    p_table_name="T_AUTENTICACION_TIPOS"
    p_owner="RISK_RISK"
    ...
    p_dml_view_name="T_AUTENTICACION_TIPOS_DML_V"
    p_dml_view_trigger_name="T_AUTENTICACION_TIPOS_IOIUD"
    p_enable_one_to_one_view="TRUE"
    p_one_to_one_view_name="T_AUTENTICACION_TIPOS_V"
    p_api_name="T_AUTENTICACION_TIPOS_API"
    p_sequence_name=""
  ...
  */
  ...
  TYPE t_rows_tab          IS TABLE OF T_AUTENTICACION_TIPOS%ROWTYPE;
  TYPE t_strong_ref_cursor IS REF CURSOR RETURN T_AUTENTICACION_TIPOS%ROWTYPE;
