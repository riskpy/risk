...
begin
  ...
  l_clob(2) :=q'!DIRECCION_CORREO_MONITOREOS!';
  l_clob(3) :=q'!Dirección de correo electrónico principal para monitoreos de conflictos!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!DIRECCION_CORREO_MONITOREOS!';
