...
begin
  ...
  l_clob(2) :=q'!MENSAJERIA_CANTIDAD_INTENTOS_PERMITIDOS!';
  l_clob(3) :=q'!Cantidad de intentos permitidos para envío de mensajes!';
  l_varchar2(4) :=q'!!';
...
begin
  ...
  l_clob(1) :=q'!MENSAJERIA_CANTIDAD_INTENTOS_PERMITIDOS!';
  l_clob(2) :=q'!3!';
