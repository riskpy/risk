...
begin
  ...
  l_varchar2(1) :=q'!33!';
  l_clob(2) :=q'!S!';
  l_clob(3) :=q'!CAMBIAR_ESTADO_MENSAJERIA!';
  l_clob(4) :=q'!MSJ!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!!';
  l_clob(7) :=q'!0.1.0!';
...
begin
  ...
  l_varchar2(1) :=q'!3!';
  l_clob(2) :=q'!SERVICIO:MSJ:CAMBIAR_ESTADO_MENSAJERIA!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
