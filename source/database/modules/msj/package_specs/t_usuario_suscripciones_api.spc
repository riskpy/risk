CREATE OR REPLACE PACKAGE T_USUARIO_SUSCRIPCIONES_API IS
  /*
  ...
  <options
    ...
    generated_by="JAVIER"
    p_table_name="T_USUARIO_SUSCRIPCIONES"
    p_owner="RISK_MSJ"
    ...
    p_dml_view_name="T_USUARIO_SUSCRIPCIONES_DML_V"
    p_dml_view_trigger_name="T_USUARIO_SUSCRIPCIONES_IOIUD"
    p_enable_one_to_one_view="TRUE"
    p_one_to_one_view_name="T_USUARIO_SUSCRIPCIONES_V"
    p_api_name="T_USUARIO_SUSCRIPCIONES_API"
    p_sequence_name=""
  ...
  */
  ...
  TYPE t_rows_tab          IS TABLE OF T_USUARIO_SUSCRIPCIONES%ROWTYPE;
  TYPE t_strong_ref_cursor IS REF CURSOR RETURN T_USUARIO_SUSCRIPCIONES%ROWTYPE;
  ...
  FUNCTION create_row (
    p_id_usuario       IN T_USUARIO_SUSCRIPCIONES.ID_USUARIO%TYPE              /*PK*/,
    p_suscripcion      IN T_USUARIO_SUSCRIPCIONES.SUSCRIPCION%TYPE             /*PK*/,
    p_fecha_expiracion IN T_USUARIO_SUSCRIPCIONES.FECHA_EXPIRACION%TYPE       DEFAULT NULL )
