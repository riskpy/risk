CREATE OR REPLACE PACKAGE BODY T_CORREO_PLANTILLAS_API IS
  /*
  ...
  */
  ...
  IS
    ...
    v_dummy  PLS_INTEGER;
    CURSOR   cur_bool IS
      SELECT 1 FROM T_CORREO_PLANTILLAS
      WHERE
  ...
  IS
    v_return T_CORREO_PLANTILLAS.ID_PLANTILLA%TYPE; 
  BEGIN
    INSERT INTO T_CORREO_PLANTILLAS (
      ID_PLANTILLA /*PK*/,
      NOMBRE,
      ACTIVO,
      ID_CATEGORIA /*FK*/,
  ...
  BEGIN
    RETURN create_row (
      ...
      p_plantilla_asunto    => p_row.PLANTILLA_ASUNTO,
  ...
  IS
    v_row T_CORREO_PLANTILLAS%ROWTYPE;
    CURSOR cur_row IS
      SELECT * FROM T_CORREO_PLANTILLAS
      WHERE
        ID_PLANTILLA = p_id_plantilla;
  BEGIN
    OPEN cur_row;
  ...
  BEGIN
    ...
    p_plantilla_asunto     := v_row.PLANTILLA_ASUNTO; 
  ...
  BEGIN
    ...
    SET
      ...
      DETALLE              = p_detalle,
      PLANTILLA_ASUNTO     = p_plantilla_asunto,
  ...
  BEGIN
    FORALL i IN INDICES OF p_rows_tab
      ...
      SET
        ...
        PLANTILLA_ASUNTO     = p_rows_tab(i).PLANTILLA_ASUNTO,
  ...
  IS
  BEGIN
    DELETE FROM T_CORREO_PLANTILLAS
    WHERE
      ID_PLANTILLA = p_id_plantilla;
  END delete_row;
  ...
  BEGIN
    ...
    THEN
      RETURN update_row (
        ...
        p_detalle             => p_detalle,
        p_plantilla_asunto    => p_plantilla_asunto,
  ...
  BEGIN
    RETURN read_row (
      p_id_plantilla => p_id_plantilla ).PLANTILLA_ASUNTO;
  END get_plantilla_asunto;
